				...
				<div className='max-w-3xl mx-auto'>
					...
					<div className='space-y-8 text-muted-foreground'>
						<p className='text-lg leading-relaxed'>
							Doc Master is a professional document alignment and
							printing tool designed to help you prepare your
							documents with precision and ease. Whether you're
							scanning dual-sided documents or organizing multiple
							pages, Doc Master provides the tools you need.
						</p>

						<div className='bg-card border border-border rounded-xl p-8'>
							<h2 className='text-2xl font-semibold text-foreground mb-6'>
								Why Choose Doc Master?
							</h2>
						...
						<div>
							...
							<p className='leading-relaxed'>
								...
								professional document management tools without
								barriers. Doc Master is built to be fast,
						...
						<div>
							...
							<p className='leading-relaxed'>
								Doc Master uses modern web technologies and free
								AI APIs to provide powerful features without the
								cost. Our platform is built on Next.js and
